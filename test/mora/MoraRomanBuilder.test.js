...
describe("Roman Builder Test", () => {
    test("hiragana to roman", () => {
        ...
        expect(builder.build("しゃ")).toEqual(expect.arrayContaining(["sha", "sya", "shilya", "shixya", "silya", "sixya", "cilya", "cixya"]));
        expect(builder.build("しぃ")).toEqual(expect.arrayContaining(["syi", "shili", "shixi", "sili", "sixi", "cili", "cixi"]));
        expect(builder.build("しゅ")).toEqual(expect.arrayContaining(["shu", "syu", "shilyu", "shixyu", "silyu", "sixyu", "cilyu", "cixyu"]));
        expect(builder.build("しぇ")).toEqual(expect.arrayContaining(["she", "sye", "shile", "shixe", "sile", "sixe", "cile", "cixe"]));
        expect(builder.build("しょ")).toEqual(expect.arrayContaining(["sho", "syo", "shilyo", "shixyo", "silyo", "sixyo", "cilyo", "cixyo"]));
        ...
        expect(builder.build("ふぁ")).toEqual(expect.arrayContaining(["fa", "fwa"]));
        expect(builder.build("ふぃ")).toEqual(expect.arrayContaining(["fi", "fwi"]));
        expect(builder.build("ふぇ")).toEqual(expect.arrayContaining(["fe", "fwe"]));
        expect(builder.build("ふぉ")).toEqual(expect.arrayContaining(["fo", "fwo"]));
